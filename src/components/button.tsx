...
export const Button = forwardRef<any, ButtonProps>(
    ({ className, ...rest }, ref) => {
        const buttonClasses = cl(
            "flex items-center justify-center gap-2 text-lg hover:bg-gray-200 active:bg-gray-300 dark:bg-transparent dark:hover:bg-gray-800 dark:active:bg-gray-700 transition-colors py-2 px-6 rounded-full dark:text-gray-200 disabled:cursor-not-allowed [&[aria-disabled='true']:cursor-not-allowed   ]",
